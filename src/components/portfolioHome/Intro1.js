...
    return (
        <div className="section">
            <h2>About Me</h2>
            <div>
                <p>Welcome to my website! My name's Jacob Chan, and I hail from the San Francisco Bay Area. I’m a student at the University of Toronto pursuing a major in Computer Science with a focus on Artificial Intelligence, and a double minor in Statistics and Mathematics.</p>
